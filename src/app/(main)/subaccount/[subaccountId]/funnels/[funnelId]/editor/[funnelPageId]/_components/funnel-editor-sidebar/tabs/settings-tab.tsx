...
const SettingsTab = (props: Props) => {
    ...
    const handleOnChanges = (e: any) => {
        ...
        if (styleSettings === 'backgroundImage') {
            // Remove any existing url() wrapper and ensure proper format
            value = value.trim();
            if (value && !value.startsWith('http') && !value.startsWith('url(')) {
        ...
        console.log('Updating:', styleSettings, 'to', value);
        const styleObject = {
            [styleSettings]: value,
        }
    ...
    console.log(state.editor.selectedElement, "selected element")
